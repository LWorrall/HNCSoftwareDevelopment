...
namespace Main_Program_v3
{
    ...
    class Deck
    {
        ...
        public static  string Draw()
        {
            ...
            switch (Convert.ToString(card.pipValue))
            {
                case "1":
                    ...
                    if (GameLogic.playersTurn == true)
                    {
                        ...
                        card.pipValue = AceDecision(hand);
                    }
                    else
                    {
            ...
            return "Card order: " + card.cardOrder + ". Card number: " + card.cardNumber + ". Pip value: "+ card.pipValue + ". Card name: " + card.pipName + ". Suit name: " + card.suitName;
